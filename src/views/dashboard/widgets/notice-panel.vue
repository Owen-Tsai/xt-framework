      ...
      <ul>
        ...
        >
          <a-tag
            ...
            class="flex-shrink-0"
          >{{ item.label }}</a-tag>
          <span class="truncate flex-grow ml-2 text-[13px] group-hover:text-gray-800">{{ item.title }}</span>
        </li>
      </ul>
...
const notice = [
  {
    color: 'orangered',
    label: '警告',
    title: '业务审核时间截止至 12 月 31 日，请尽快完成审核'
  },
  {
    color: 'blue',
    label: '待办',
  ...
  },
  {
    color: 'cyan',
    label: '消息',
    title: '2022年12月系统升级维护计划'
  },
  {
    color: 'cyan',
    label: '消息',
    title: '您被 @超级管理员 新增了 1 项事务权限'
  },
  {
    color: 'cyan',
    label: '消息',
